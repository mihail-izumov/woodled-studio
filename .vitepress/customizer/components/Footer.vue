  ...
  >
    ...
    >
      ...
      >
        ...
        >
          Сколько света нужно вашему дому? <br class="m-br" />Как создать в&nbsp;нём <br class="m-br" />неповторимое настроение?
        </p>
        <p
          :style="{
            margin: '0 0 14px',
        ...
        >
          Настоящий свет&nbsp;— это не люксы и&nbsp;люмены. <br class="m-br" />Это тёплые сумерки, утро в&nbsp;лесу <br class="m-br" />и&nbsp;ясный полдень. Это мягкое тепло <br class="m-br" />дуба и&nbsp;ореха в&nbsp;каждой комнате. <br class="m-br" />Описать это словами трудно. <br class="m-br" />Именно поэтому мы за это и&nbsp;берёмся.
        </p>
        ...
        >
          Больше живых домов. <br class="m-br" />Для себя, семьи и&nbsp;близких&nbsp;— для&nbsp;жизни.
        </p>
      </div>
    </div>
  </footer>
...
<style scoped>
/* Ручные переносы строк в манифесте — только на мобильной ширине.
   <br class="m-br"> переносит на телефоне; на десктопе (≥600px) скрыт,
   и текст переносится естественно. Перед каждым <br> стоит обычный
   пробел → при скрытии слова не слипаются. */
