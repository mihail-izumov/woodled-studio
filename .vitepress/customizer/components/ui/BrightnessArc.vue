 ...
 *   Темно → тусклое тонкое солнце; Праздник → яркое и крупное.
 *
...
function draw() {
  ...
  const lvl = [
    { sun: 0.15, sunM: 0.04, sR: 22, bg: 0.10, bgM: 0.03 }, // 0 — Темно
    { sun: 0.32, sunM: 0.10, sR: 28, bg: 0.18, bgM: 0.06 }, // 1 — Полусвет
    { sun: 0.60, sunM: 0.22, sR: 34, bg: 0.30, bgM: 0.10 }, // 2 — Светло
    { sun: 0.82, sunM: 0.32, sR: 40, bg: 0.42, bgM: 0.14 }, // 3 — Ярко
    { sun: 1.00, sunM: 0.40, sR: 46, bg: 0.55, bgM: 0.18 }, // 4 — Праздник
  ][brightIdx]
