...
const FULL: Record<'ok' | 'plenty' | 'over', readonly string[]> = {
  ok: ['Света в самый раз.', 'Всё на местах, света достаточно.', 'Света достаточно.'],
  plenty: ['Света с запасом — при желании можно приглушить.', 'Яркости в избытке, но всё в порядке.'],
  over: [
    'Света больше, чем надо — глазам столько не нужно. Можно приглушить или добавить диммер.',
    'Перебор по свету. Стоит снять пару светильников или поставить диммер.',
  ],
}
