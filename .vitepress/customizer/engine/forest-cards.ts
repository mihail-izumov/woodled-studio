...
const WALL_MEDIUM = [
  'Нейтральные стены ничего не добавляют и не забирают. Норма комнаты — как в расчёте.',
  'Стены среднего тона по свету нейтральны: норму не поправляем.',
  'Стены не помогают и не мешают свету. Считаем по основной норме.',
] as const
const WALL_DARK = [
