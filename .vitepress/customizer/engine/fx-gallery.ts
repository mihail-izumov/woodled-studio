 ...
 *  Перечисляет параметры, которые юзер выбирает в форме, но в матчере не участвуют
 *  (либо данных в разметке нет, либо видно плохо: bowl 0/179, btemp 9/179, цоколь — не виден). */
export const HERO_DISCLAIMER = 'Фото не отражает выбор чаши, цоколя, температуры и количества ламп'
