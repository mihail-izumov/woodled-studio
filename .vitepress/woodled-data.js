...
// Bottom-button labels per step — yes-set реакции, телесные/иронично-тихие:
//   0 (срубили дерево, свет остался)        → «Тронуло» — сопричастие
//                                             без позы (соврем. ирония).
//   1 (ламели в круг, «воздух между ними»)  → «Дышу» — реакция-вдох,
//                                             кнопка превращается в часть
//                                             момента, не в оценку.
//   2 (живой дом, 3 комнаты, лес оживает)   → «Супер!» — восторг
//   3 (Дизайнер — это Я)                    → своя CTA, .bb скрыт
export const BTN_LABELS = ['Тронуло', 'Дышу', 'Супер!', '']
