...
export const IMG = {
  oak: '/woodled-studio/onboarding/oak.svg',
  rotor: '/woodled-studio/onboarding/rotor.png',
  wood: '/woodled-studio/onboarding/wood.jpg',
  interior: '/woodled-studio/onboarding/interior.jpg',
  bird: '/woodled-studio/onboarding/bird.svg',
  rabbit: '/woodled-studio/onboarding/rabbit.svg',
  squirrel: '/woodled-studio/onboarding/squirell.svg'
}

// Audio source
export const AUDIO_SRC = '/woodled-studio/onboarding/forest-soundscape.mp3'
...
export const CUSTOMIZER_URL = '/woodled-studio/customizer'
